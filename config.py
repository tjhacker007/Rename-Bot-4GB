...
API_ID = int(os.environ.get("API_ID", "21642624"))
API_HASH = os.environ.get("API_HASH", "")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "")
ADMIN = int(os.environ.get("ADMIN", "1885113059"))
...
FORCE_SUBS = os.environ.get("FORCE_SUBS", "-1002129691288")
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002659880348"))
